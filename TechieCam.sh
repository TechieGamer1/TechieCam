...
echo '
         ...
         /hNNMddNMd:..                        ..:dMNddMNNh/
        +mNdNdmMMd.-.                          .-.dMMmdNdNm+
       NNhNNdMMM:--`  🇮🇳 Techie Gamer 🇮🇳    --:MMMdNNyNN/
         ...
         shdmNMMMMMNMMMmmd/      ``      /dmmMMMNMMMMMNmNhy//
             :mMMmMMy:-`                `-:yMMmMMm://:dh+:
               ...
               yMModdM. y`-s`:y.//.y:`s-`y -MddoMMy-h+:Nh:+
                ...
                MM:. /+`h.h:/Techie Gamer/:h.h`+/`-:/MMdymd+/
                   Mh/`  ..+.h.-y // y-.h.+..-hhNNMNdh+/
                   Nh+-`  `..-+.//.+-..`  `/dmMMMo/  
                      h+-``          ``-+hmNhyy+/  
                     smNmh+-````````-+hmNms++yh  
...
echo '
  ...
  ".________________@Techie_Gamer_________________." ' |lolcat
                                                                              
echo " "
printf "\e[1;93m[\e[0m\e[1;77m+\e[0m\e[1;93m]Tool link  :\e[0m\e[1;77m %s\e[0m\n https://www.github.com/TechieGamer1/TechieCam"
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m+\e[0m\e[1;93m] Telegram Channel :\e[0m\e[1;77m %s\e[0m\n https://t.me/Techie_Gamer"
printf "\n"
